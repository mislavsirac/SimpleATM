                ...
                <td align="center">
                  ...
                  Balance: <?php echo $data['balance']; ?> <br>
                    <form class="index_login_form" method="post" style="margin-top:50px;">
                        ...
                        <div class="form-group"><input id="amount" class="form-control" type="text" name="amount" placeholder="Enter the amount to withdraw" /></div>
                        <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Withdraw</button></div></form>
